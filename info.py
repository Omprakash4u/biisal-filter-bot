...
BOT_TOKEN = environ.get('BOT_TOKEN', '7167823797:AAHnrBgaWCWnSQ7F838QRAQO2auiboiJby0')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2145003945').split()]
